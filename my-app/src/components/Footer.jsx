...
const Footer=()=>{
    return(
        <Box w="100%" background="RGB(144, 39, 53)" h="33rem" display="flex" marginTop="2rem">
            <Box>
                ...
                <Text marginLeft="5rem" paddingTop=".5rem" color="white" fontSize="1rem" fontWeight="500">PAYMENT OPTIONS</Text>
               ...
               <Image marginLeft="1rem"  width="40px" h="35px" src="https://upload.wikimedia.org/wikipedia/commons/thumb/8/80/Maestro_2016.svg/1200px-Maestro_2016.svg.png"/>
               <Image marginLeft="1rem"  width="40px" h="40px" src="https://brand.mastercard.com/content/dam/mccom/brandcenter/brand-history/brandhistory_mc_vrt_120_2x.png"/>
            </Box>
            <Box>
